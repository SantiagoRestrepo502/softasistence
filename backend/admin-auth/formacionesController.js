...
class FormacionesController {
    ...
    async getFormacion(req, res) {
        try {
            ...
            const formacion = await formacionService.getFormacionById(id);
    ...
    async createFormacion(req, res) {
        try {
            ...
            // Validar jornada
            const jornadasPermitidas = ['diurna', 'nocturna', 'mixta', 'fin_de_semana'];
            ...
            const newId = await formacionService.createFormacion({
                codigo,
                nombre,
                jornada,
                fecha_inicio,
    ...
    /**
     * PUT /api/formaciones/:id
     * Actualiza una formación
     */
    async updateFormacion(req, res) {
        try {
            const { id } = req.params;
            const { codigo, nombre, jornada, fecha_inicio, fecha_fin } = req.body;
            ...
            const updated = await formacionService.updateFormacion(id, updateData);
    ...
    async toggleFormacion(req, res) {
        try {
            ...
            const updated = await formacionService.toggleFormacionStatus(id);
    ...
    async deleteFormacion(req, res) {
        try {
            ...
            const deleted = await formacionService.deleteFormacion(id);
